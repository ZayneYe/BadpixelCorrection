...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs, mask, org_imgs, mask_ratio=0.75, dataset='S7-ISP'):
...
if __name__ == "__main__":
    model = mae_vit_base_patch16(img_size=500, in_chans=1)
    # torch.save(model, 'vit.pt')
    x = torch.rand((1,1,500,500))
    ...
    print(x.shape)
    print(y.shape)
    flops, params = get_model_complexity_info(model, (1, 378, 504), as_strings=True, print_per_layer_stat=True)
    print('Flops:  ' + flops)
    print('Params: ' + params)